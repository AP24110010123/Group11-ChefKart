      ...
      <section className="hero">
        ...
        <div className="container hero-content">
          <div className="hero-text">
            ...
            <h1>Restaurant-Quality Meals <em>In Your Kitchen</em></h1>
            <p>Hire certified, background-verified professional chefs for daily cooking, special occasions, or subscribe for weekly meal plans.</p>
